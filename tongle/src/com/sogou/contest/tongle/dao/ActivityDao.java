...
//		public static final String A_INFO = "info";//详细信息
	...
	public void insert_test() {
		...
		for (int i=0;i<10;i++){
			...
			values.put("activity", INTEREST_TAGS[new Random().nextInt(INTEREST_TAGS.length)]);//标签
	 ...
	 * @return
	 */
	public List<User> query(String zd,String str) {
		SQLiteDatabase db = helper.getReadableDatabase();
		Cursor c = db.query(Constant.TongleActivity.TB_NAME, null, zd + "=?", new String[]{str}, null, null, "age DESC");
