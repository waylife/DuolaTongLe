 ...
 */
public class FocusedFriendsAdater extends BaseAdapter {
    private List<?> lists;
    private Context mContext;
    private BitmapUtils bitmapUtils;

    public FocusedFriendsAdater(List<?> list, Context ct) {
        this.lists = list;
        this.mContext = ct;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = View.inflate(mContext, R.layout.item_focused_friend_view, null);
