...
public class JoinedAdapter extends BaseAdapter {
    ...
    public JoinedAdapter(List<?> list, Context ct) {
        this.lists = list;
        this.mContext = ct;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = View.inflate(mContext, R.layout.item_joined_view, null);
            ...
            holder.flag_view = (TextView) convertView.findViewById(R.id.flag);
